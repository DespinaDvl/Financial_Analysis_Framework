...
If you want to skip this step please enter \'Y\', otherwise enter \'N\', OR enter \'Exit\' to terminate program.")
            while True:
                skip_intro = input("\nDo you wish to skip this step?")
                if re.match(r'Ye', skip_intro.strip(), re.IGNORECASE):  #Regular experssions (RegEx) have been used to provide an extra level of flexibility
